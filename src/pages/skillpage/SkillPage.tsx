        ...
        <Wrapper>
            ...
            <Container>
                <Text style={{ marginTop: "2rem" }}>
                    ...
                    amet consectetur adipisicing elit. Inventore recusandae est
                    doloremque cupiditate. Blanditiis ea corrupti, similique
                    praesentium necessitatibus minus tempore asperiores quo
                    nobis eaque architecto, cum qui, inventore maxime. Lorem
                    ipsum dolor sit amet consectetur, adipisicing elit. Impedit
                    id molestias et a, optio veritatis tempora tenetur minima
                    veniam sapiente sed consequuntur quae praesentium
                    perspiciatis incidunt, magnam obcaecati quo labore?
                </Text>
                <SkillWrapper>
                    <ParallexWrapper>
                        <Parallex>
                            <ParallexItem x={5} y={10} size={2}>
                                Dart
                            </ParallexItem>
                            <ParallexItem x={85} y={20} size={1.8}>
                                CSS
                            </ParallexItem>
                            <ParallexItem x={50} y={80} size={1}>
                                HTML
                            </ParallexItem>
                            <ParallexItem x={40} y={10} size={2}>
                                Flutter
                            </ParallexItem>
                            <ParallexItem x={75} y={70} size={1.3}>
                                Firebase
                            </ParallexItem>
                            <ParallexItem x={12} y={74} size={1}>
                                MongoDB
                            </ParallexItem>
                            <ParallexItem x={25} y={50} size={1.6}>
                                Figma
                            </ParallexItem>
                            <ParallexItem x={70} y={30} size={1}>
                                Gatsby
                            </ParallexItem>
                        </Parallex>
                    </ParallexWrapper>
